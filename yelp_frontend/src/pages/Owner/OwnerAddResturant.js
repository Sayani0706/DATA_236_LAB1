  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (photo) {
        ...
        await api.post(`/owner/restaurants/${restaurantId}/photos`, formDataPhoto, {
    ...
    <div className="container mt-4">
      <form onSubmit={handleSubmit} className="card p-4 shadow-sm">
        ...
        <p className="text-muted small mb-3">
          This restaurant will be automatically claimed under your account.
        </p>
...
export default OwnerAddRestaurant;
